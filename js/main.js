...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(() => {
        ...
        if (document.getElementById('typescript-tab')) {
            showTab('typescript');
        }
...
function handleFormSubmission(e) {
    ...
    // Submit via iframe
    submitViaIframe(formData, 'https://script.google.com/macros/s/AKfycbxV0hKouwyW2TnTZcQgL0hhBAxM8xln4O0dWF08S39FqcJY1s9Zknv8Mbkv_PXLqlQMAQ/exec');
